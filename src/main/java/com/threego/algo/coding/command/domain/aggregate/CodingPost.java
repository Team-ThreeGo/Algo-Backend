...
public class CodingPost {
    ...
    public CodingPost(Member member, CodingProblem problem, String title, String content) {
        this.member = member;
    ...
    public static CodingPost create(Member member, CodingProblem problem, String title, String content) {
        return new CodingPost(member, problem, title, content);
    }
